...
register(); // this registers swiper web components
...
export class HomePage implements OnInit {
  ...
  /* --- प्रोग्राम 8 को दो भागों में विभाजित किया गया --- */
  {
    ...
    short_desc: 'किसानों को आधुनिक कृषि यंत्रों के उपयोग, रखरखाव और सरकारी योजनाओं का लाभ दिलाना।'
  },
  {
    id: 9,
    icon: 'sunny-outline',
    name: 'वृक्षारोपण एवं पर्यावरण संरक्षण',
    short_desc: 'हरियाली बढ़ाने के लिए पौधरोपण अभियान और प्रकृति के प्रति जागरूकता फैलाना।'
  }
];
