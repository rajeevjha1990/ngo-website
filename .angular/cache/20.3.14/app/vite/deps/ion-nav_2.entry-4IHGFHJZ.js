...
var Nav = class {
  ...
  componentDidLoad() {
    return __async(this, null, function* () {
      this.didLoad = true;
      this.rootChanged();
      this.gesture = (yield import("./swipe-back-BKw2CAHc-UYXO7JFQ.js")).createSwipeBackGesture(this.el, this.canStart.bind(this), this.onStart.bind(this), this.onMove.bind(this), this.onEnd.bind(this));
...
@ionic/core/dist/esm/ion-nav_2.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-nav_2.entry-4IHGFHJZ.js.map
